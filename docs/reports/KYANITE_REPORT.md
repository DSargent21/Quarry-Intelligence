...
<header>
    ...
    <div class="subtitle">A Comprehensive Technical Synthesis of High-Certainty Gradient Boosting DNA and the Systematic Optimization of Optical Win-Rate Consistency in Predictive Intelligence</div>
    <div class="meta-info">
...
<div class="figure-container">
    <img src="../assets/kyanite_sport.png" alt="Kyanite Market Coverage">
    <div class="figure-caption">Figure 1.1: Kyanite Surgical Deployment. The engine identifies high-certainty favorites across the institutional spectrum.</div>
</div>

<div class="figure-container">
    <img src="../assets/kyanite_signature.png" alt="Kyanite Signature Graphic">
    <div class="figure-caption">Figure 1.2: The Kyanite Signature Graphic. This visualization represents the "Surgical DNA Cluster"—the engine's unique approach to identifying the genetic markers of a winning strategy.</div>
</div>
...
<div class="math-image-container">
    <img src="../assets/kyanite_rho.png" alt="Autocorrelation Formula">
</div>

<div class="figure-container">
    <img src="../assets/kyanite_transition.png" alt="State Transition Matrix">
    <div class="figure-caption">Figure 2.1: Transition Probabilities. Kyanite captures the momentum transition from Neutral to peak performance states.</div>
</div>
...
<div class="math-image-container">
    <img src="../assets/kyanite_ruin.png" alt="Ruin Probability Formula">
</div>
...
<div class="math-image-container">
    <img src="../assets/academic_kyanite_threshold.png" alt="Threshold Formula">
</div>

<div class="figure-container">
    <img src="../assets/kyanite_volume.png" alt="Kyanite Signal Density">
    <div class="figure-caption">Figure 3.1: Inference Velocity. Kyanite maintains high-frequency monitoring to identify surgical entry windows.</div>
</div>
...
<div class="figure-container">
    <img src="../assets/kyanite_matrix.png" alt="Kyanite Inference Matrix">
    <div class="figure-caption">Figure 3.2: The Winning Formula DNA. Kyanite's inference logic isolates the exact combination of feature weights that result in a 'Super-Linear' win probability.</div>
</div>
...
<div class="figure-container">
    <img src="../assets/kyanite_alpha.png" alt="Alpha Math Formula">
    <div class="figure-caption">Figure 4.1: The Alpha Signal. Kyanite's feature hierarchy is optimized for high-certainty win capture.</div>
</div>

<div class="figure-container">
    <img src="../assets/kyanite_decay.png" alt="Momentum Decay Curve">
    <div class="figure-caption">Figure 4.2: Expected Win-Rate Decay vs. Time. The rapid collapse of signal integrity necessitates high-frequency monitoring. Kyanite enforces a strict 48-hour freshness protocol.</div>
</div>
...
<div class="figure-container">
    <img src="../assets/kyanite_synergy.png" alt="Synergy Heatmap">
    <div class="figure-caption">Figure 4.3: Cross-Sport Momentum Synergy. The heatmap reveals a 57.7% correlation between Soccer success and subsequent NHL alpha. Kyanite builds "Confidence Clusters" to isolate the smartest money.</div>
</div>

<div class="figure-container">
    <img src="../assets/kyanite_importance.png" alt="Kyanite Feature Importance">
    <div class="figure-caption">Figure 4.4: SHAP Value Distribution. Gradient boosting DNA and edge hurdles dominate the predictive hierarchy.</div>
</div>
</div>
...
<div class="figure-container">
    <img src="../assets/kyanite_calibration.png" alt="Kyanite Calibration Curve">
    <div class="figure-caption">Figure 5.1: Model Calibration Audit. Kyanite maintains extreme alignment between predicted certainty and surgical outcomes.</div>
</div>
...
<div class="figure-container">
    <img src="../assets/kyanite_equity.png" alt="Kyanite Equity Curve">
    <div class="figure-caption">Figure 5.2: Kyanite Institutional Performance (N=500). The steady upward drift with zero catastrophic variance validates Kyanite's architecture as a Tier-1 financial instrument.</div>
</div>
...
<div class="figure-container">
    <img src="../assets/kyanite_fatigue.png" alt="Fatigue Decay Curve">
...
<div class="figure-container">
    <img src="../assets/kyanite_clv.png" alt="CLV Paradox Chart">
    <div class="figure-caption">Figure 7.1: Realized WR vs. Market Drift. Kyanite signals thrive in the "Negative Drift" quadrant, proving that Momentum Alpha overrides Price Alpha.</div>
</div>
...
<div class="figure-container">
    <img src="../assets/kyanite_size.png" alt="Kyanite Sizing Profile">
    <div class="figure-caption">Figure 8.1: Dynamic Position Sizing. Sizing is scaled according to surgical certainty, ensuring maximum yield during peak windows.</div>
</div>
...
<div class="figure-container">
    <img src="../assets/kyanite_simulation.png" alt="Kyanite Final Simulation">
    <div class="figure-caption">Figure 9.1: Long-Term Institutional Projection. In a 2,500-trade sequence, the Kyanite architecture demonstrates consistent positive drift with zero catastrophic variance.</div>
</div>
</div>
